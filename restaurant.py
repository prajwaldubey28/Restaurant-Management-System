...
Tops =Frame(root,width=1600,height=50,relief=SUNKEN,bg="black")
Tops.pack(side=TOP)
...
# -----------------INFO TOP------------
lblinfo = Label(Tops, font=('aria', 35, 'bold'), text="Restaurant Management System", fg="red", bg='black', bd=10,
anchor='w', pady=20)
lblinfo.grid(row=0, column=0,columnspan = 5)
lblinfo = Label(Tops, font=('aria', 20,), text=localtime, fg="red", bg='black', anchor=W, pady=10)
